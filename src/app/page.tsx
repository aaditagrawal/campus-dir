    ...
    <main className="max-w-5xl mx-auto px-6 py-14 md:py-24 grid gap-12">
      ...
      <section className="grid gap-3">
        <div className="overflow-hidden rounded-xl border-2 border-amber-600/35 bg-amber-500/[0.07] shadow-md transition-shadow hover:shadow-lg dark:border-amber-500/40 dark:bg-amber-500/10">
          ...
          >
            <Shuffle className="size-5 shrink-0 text-amber-700 dark:text-amber-400" aria-hidden />
            <div className="min-w-0 flex-1 text-left">
              <p className="text-base font-semibold tracking-tight">Call Random Auto</p>
          ...
          >
            <Phone className="size-5 shrink-0 text-amber-700 dark:text-amber-400" aria-hidden />
            <div className="min-w-0 flex-1 text-left">
              <p className="text-base font-semibold tracking-tight">Explore Autos list</p>
              <p className="text-sm text-muted-foreground">
        ...
        >
          <Car className="size-5 shrink-0 text-neutral-950" aria-hidden />
          <div className="min-w-0 flex-1 text-left">
            <p className="text-base font-semibold tracking-tight text-neutral-950">Get taxis</p>
        ...
        >
          <Mail className="size-5 shrink-0 text-emerald-600 dark:text-emerald-400" aria-hidden />
          <div className="min-w-0 flex-1 text-left">
            <p className="text-base font-semibold tracking-tight">Generate Mail to Warden</p>
            <p className="text-sm text-muted-foreground">Leave requests &amp; hostel email</p>
          </div>
          <ChevronRight
            className="size-5 shrink-0 text-muted-foreground transition-transform group-hover:translate-x-0.5"
            aria-hidden
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <Link href="/academics" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Systems & portals</p>
          </div>
        </Link>
        <Link href="/restaurants" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Menus & delivery</p>
          </div>
        </Link>
        <Link href="/hostels" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Wardens & contacts</p>
          </div>
        </Link>
        <Link href="/travel" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Autos, cabs & taxis</p>
          </div>
        </Link>
        <Link href="/services" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Laundry & xerox</p>
          </div>
        </Link>
        <Link href="/tools" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Maps & resources</p>
          </div>
        </Link>
        ...
        <Link href="/grievance" className="group">
          <div className="h-full p-5 sm:p-6 rounded-xl border border-border/50 bg-card/60 hover:bg-card hover:border-border/80 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <p className="text-sm text-muted-foreground leading-snug">Complaints & contacts</p>
          </div>
        </Link>
          ...
          <div className="h-full p-5 sm:p-6 rounded-xl border border-rose-400/40 bg-rose-500/5 hover:bg-rose-500/10 hover:border-rose-400/60 hover:shadow-md hover:shadow-rose-500/10 hover:-translate-y-0.5 transition-all duration-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-rose-500/80">Clinic, ambulance & security</p>
              </div>
            </div>
          </div>
        </Link>
